...
from maniml.manimgl_core.utils.rate_functions import linear
from maniml.manimgl_core.utils.rate_functions import double_smooth
...
if TYPE_CHECKING:
    ...
    from maniml.manimgl_core.scene.scene import Scene
