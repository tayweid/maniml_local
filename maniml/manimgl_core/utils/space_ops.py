...
from maniml.manimgl_core.constants import DOWN, OUT, RIGHT, UP
...
if TYPE_CHECKING:
    ...
    from maniml.manimgl_core.typing import Vect2, Vect3, Vect4, VectN, Matrix3x3, Vect3Array, Vect2Array
