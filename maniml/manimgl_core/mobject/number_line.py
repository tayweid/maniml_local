...
from maniml.manimgl_core.constants import DOWN, LEFT, RIGHT, UP
from maniml.manimgl_core.constants import DEFAULT_LIGHT_COLOR
...
if TYPE_CHECKING:
    ...
    from maniml.manimgl_core.typing import ManimColor, Vect3, Vect3Array, VectN, RangeSpecifier
