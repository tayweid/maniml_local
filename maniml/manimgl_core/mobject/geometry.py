...
from maniml.manimgl_core.constants import DL, DOWN, DR, LEFT, ORIGIN, OUT, RIGHT, UL, UP, UR
from maniml.manimgl_core.constants import RED, BLACK, DEFAULT_MOBJECT_COLOR, DEFAULT_LIGHT_COLOR
from maniml.manimgl_core.constants import MED_SMALL_BUFF, SMALL_BUFF
from maniml.manimgl_core.constants import DEG, PI, TAU
from maniml.manimgl_core.mobject.mobject import Mobject
from maniml.manimgl_core.mobject.types.vectorized_mobject import DashedVMobject
...
from maniml.manimgl_core.utils.iterables import adjacent_n_tuples
from maniml.manimgl_core.utils.iterables import adjacent_pairs
from maniml.manimgl_core.utils.simple_functions import clip
from maniml.manimgl_core.utils.simple_functions import fdiv
...
from maniml.manimgl_core.utils.space_ops import compass_directions
from maniml.manimgl_core.utils.space_ops import find_intersection
from maniml.manimgl_core.utils.space_ops import get_norm
from maniml.manimgl_core.utils.space_ops import normalize
from maniml.manimgl_core.utils.space_ops import rotate_vector
...
if TYPE_CHECKING:
    ...
    from maniml.manimgl_core.typing import ManimColor, Vect3, Vect3Array, Self
