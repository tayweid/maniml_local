...
from maniml.manimgl_core.constants import DEFAULT_MOBJECT_TO_EDGE_BUFF
from maniml.manimgl_core.constants import DEFAULT_MOBJECT_TO_MOBJECT_BUFF
from maniml.manimgl_core.constants import DOWN, IN, LEFT, ORIGIN, OUT, RIGHT, UP
from maniml.manimgl_core.constants import FRAME_X_RADIUS, FRAME_Y_RADIUS
from maniml.manimgl_core.constants import MED_SMALL_BUFF
from maniml.manimgl_core.constants import TAU
from maniml.manimgl_core.constants import DEFAULT_MOBJECT_COLOR
...
from maniml.manimgl_core.logger import log
from maniml.manimgl_core.shader_wrapper import ShaderWrapper
from maniml.manimgl_core.utils.color import color_gradient
from maniml.manimgl_core.utils.color import color_to_rgb
from maniml.manimgl_core.utils.color import get_colormap_list
from maniml.manimgl_core.utils.color import rgb_to_hex
from maniml.manimgl_core.utils.iterables import arrays_match
from maniml.manimgl_core.utils.iterables import array_is_constant
from maniml.manimgl_core.utils.iterables import batch_by_property
from maniml.manimgl_core.utils.iterables import list_update
from maniml.manimgl_core.utils.iterables import listify
...
from maniml.manimgl_core.utils.paths import straight_path
from maniml.manimgl_core.utils.shaders import get_colormap_code
from maniml.manimgl_core.utils.space_ops import angle_of_vector
...
if TYPE_CHECKING:
    ...
    from maniml.manimgl_core.typing import ManimColor, Vect3, Vect4Array, Vect3Array, UniformDict, Self
...
class Mobject(object):
    ...
    def add_background_rectangle(
        ...
        **kwargs
        ...
        from maniml.manimgl_core.mobject.shape_matchers import BackgroundRectangle
...
class _AnimationBuilder:
    ...
    def build(self):
        from maniml.manimgl_core.animation.transform import _MethodAnimation
