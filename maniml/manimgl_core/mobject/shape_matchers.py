...
from maniml.manimgl_core.constants import BLACK, RED, YELLOW, DEFAULT_MOBJECT_COLOR
from maniml.manimgl_core.constants import DL, DOWN, DR, LEFT, RIGHT, UL, UR
...
if TYPE_CHECKING:
    ...
    from maniml.manimgl_core.typing import ManimColor, Self
