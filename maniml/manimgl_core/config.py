...
def get_manim_dir():
    # For standalone maniml, use the manimgl_core directory
    manimgl_core_module = importlib.import_module("maniml.manimgl_core")
    manimgl_core_dir = os.path.dirname(inspect.getabsfile(manimgl_core_module))
    return manimgl_core_dir
